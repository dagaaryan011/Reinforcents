...
class Agent():
    def __init__(self, alpha=0.0001, beta=0.001, input_dims=[8], tau=0.005,env = None,
                 gamma=0.99, n_actions=2, max_size=10000,
        ...
        self.target_actor = ActorNetwork(fc1_dims=fc1, fc2_dims=fc2,
    ...
    def choose_action(self, observation, evaluate=False):
        ...
        return actions[0]
    def learn(self):    
        if self.memory.memcntr < self.batch_size:
            return
        ...
        with tf.GradientTape() as tape:
            ...
            target = reward + self.gamma*critic_value_*(1 - tf.cast(done, dtype=tf.float32))
